...
//! digest length. The unkeyed defaults implement [`crate::crypto::digest::Digest`].

use crate::crypto::digest::Digest;
use crate::crypto::util::{load_u64_le, store_u64_le};
...
impl Blake2b {
    ...
    pub fn new_keyed(key: &[u8]) -> Result<Self, crate::crypto::InvalidLength> {
    ...
    pub fn with_params(
        digest_len: usize,
        key: &[u8],
    ) -> Result<Self, crate::crypto::InvalidLength> {

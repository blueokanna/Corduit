...
impl ConnectionDto {
    ...
    pub fn from_tracked_connection(
        conn: &corduit_core::connection_tracker::TrackedConnection,
    ) -> Self {
        Self {
            id: conn.id.clone(),
...
impl ProxyInfoDto {
    ...
    pub fn from_outbound_config(config: &corduit_core::OutboundConfig) -> Self {
        Self {
...
impl ProxyGroupDto {
    ...
    pub fn from_outbound_config(config: &corduit_core::OutboundConfig) -> Option<Self> {
...
impl RuleDto {
    ...
    pub fn from_rule_config(config: &corduit_core::RuleConfig) -> Self {
        Self {
...
impl DnsConfigDto {
    ...
    pub fn from_dns_config(config: &corduit_core::DnsConfig) -> Self {
        Self {
